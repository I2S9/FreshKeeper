                            ...
                            <div className="hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                                <Link href="#" className="flex items-center justify-center w-max rounded-full border-t border-foreground/30 bg-white/20 backdrop-blur-lg px-2 py-1 md:py-2 gap-2 md:gap-8 shadow-3xl shadow-background/40 cursor-pointer select-none">
                                    <p className="text-foreground text-sm text-center md:text-base font-medium pl-4 pr-4 lg:pr-0">
                                        Start generating your dream receipe now!
                                    </p>
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-semibold mt-6">
                            Three steps to generate your own recipe
                        </h2>
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <p className="text-muted-foreground mt-6">
                            FreshKeeper offers a comprehensive set of features to help you effortlessly manage your pantry and create delicious meals with ease
                        </p>
                    </div>
                </Container>
                <Container>
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <p className="text-muted-foreground mt-6">
                            Choose the best plan for your needs and start organizing your pantry today
                        </p>
                    </div>
                </Container>
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between w-full px-4 md:px-8 rounded-lg lg:rounded-2xl border border-border/80 py-4 md:py-8">
                            <div className="flex flex-col items-start gap-4 w-full">
                                ...
                                <p className="text-base text-muted-foreground">
                                    Be up to date with everything about FreshKeeper
                                </p>
                            </div>
